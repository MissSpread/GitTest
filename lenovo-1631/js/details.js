$(function(){
	...
	$(".guan ul li p").click(function(){
		...
		if($(".li2-2").attr("index") == "1"){
			...
			$(".guan-li2 p").first().attr("class","li2-2");
...
$(function(){
	$.ajax({
		...
		success:function(de){
			...
			$(".cob-ul li h3 span").click(function(){
				if($(this).attr("index") == "1"){
					$(this).removeAttr("index").css("background","url(images/shoppingcart/buycart.png) -167px -4px");
					// 取消选中 总价 减少
					var span = $(".cob-right h2 span").html();
					var span2 = $(".cob-right h3 span").html();
					var arr = span.split(" ");
					var arr2 = span2.split(" ");
					arr.splice(0,1);
					arr2.splice(0,1);
					arr = Number(arr);
					arr2 = Number(arr2);
					$(".cob-right h2 span").html(arr - 99 + ".00")
					$(".cob-right h2 span").html("￥ " + $(".cob-right h2 span").html())
					$(".cob-right h3 span").html(arr2 - 20 + ".00")
					$(".cob-right h3 span").html("￥ " + $(".cob-right h3 span").html())
				}else{
					$(this).attr("index","1").css("background","url(images/details/logo.png) -99px -9px");
