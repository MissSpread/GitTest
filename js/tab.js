	...
	$.ajax({
		...
		success:function(tab){
			...
			for(var i = 0; i < tab.length; i++){
				...
				for(var k = 5; k <= 14; k++){
					if(tab[i].id == k){
						html += '<li><a class="goodsimg" href="details.html"><img src="' + tab[i].img + '"><div class="goods-bg"></div></a><a class="title" href="details.html">' + tab[i].a + '<em>' + tab[i].em + '</em></a><p>' + tab[i].p + '</p><h3>' + tab[i].h3 + '</h3><div class="buy"><div class="shop">加入购物车</div><div class="col">收藏</div></div></li>'
					}
				}
				$(".goods").html(html);
